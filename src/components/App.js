...
function Header(props) {
  return (
    <><header className="App-header">
      <nav>
        <span className="App-logo"><a href="https://github.com/Hartye/react-gazeta-news">Gazeta News</a></span>
        <span className="App-page">{props.page}</span>
        <span className="App-menu" onClick={props.menuToggle}>Menu</span>
      </nav>
    </header><Menu menu={props.menu} /></>
  )
};
...
class App extends React.Component {
  ...
  menu() {
    this.setState({
      menu: this.state.menu == true ? false: true
    })
  }
  ...
  render() {
    return (
      <div className='App'>
      <Header page={this.props.page} menu={this.state.menu} menuToggle={this.menu} />
      <Main />
    </div>
    )
  }
